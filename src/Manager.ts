...
export class Manager {
  ...
  public static twitchRedeems: Redeem[] = [
    new Redeem(['Catch A Wolfamon'], [
      new Action(ActionType.ROTATE, 0.75, true, 500),
      new Action(ActionType.VIBRATE, 0.75, 500),
    ]),
    new Redeem(['Pet the Wolf', 'Shake That Butt (VR Only)'], [
      new Action(ActionType.ROTATE, 0.2, true, 10_000),
      new Action(ActionType.VIBRATE, 0.2, 10_000),
    ]),
    new Redeem(['Give Me Your Milk!'], [
      new Action(ActionType.ROTATE, 0.35, true, 15_000),
      new Action(ActionType.VIBRATE, 0.35, 15_000),
    ]),
    new Redeem(['Nut Button'], [
      new Action(ActionType.ROTATE, 1, true, 2_000),
      new Action(ActionType.VIBRATE, 1, 2_000),
    ]),
    new Redeem(['Waste of Points'], [
      new Action(ActionType.ROTATE, 0.2, true, 2_000),
      new Action(ActionType.VIBRATE, 0.2, 2_000),
      new Action(ActionType.ROTATE, 0.35, true, 1_000),
      new Action(ActionType.VIBRATE, 0.35, 1_000),
      new Action(ActionType.ROTATE, 0.5, true, 500),
      new Action(ActionType.VIBRATE, 0.5, 500),
      new Action(ActionType.ROTATE, 1, true, 2_000),
      new Action(ActionType.VIBRATE, 1, 2_000),
      new Action(ActionType.ROTATE, 0.8, true, 500),
      new Action(ActionType.VIBRATE, 0.8, 500),
      new Action(ActionType.ROTATE, 0.5, true, 5_000),
      new Action(ActionType.VIBRATE, 0.5, 5_000),
      new Action(ActionType.ROTATE, 0.8, true, 2_000),
      new Action(ActionType.VIBRATE, 0.8, 2_000),
      new Action(ActionType.ROTATE, 1, true, 500),
      new Action(ActionType.VIBRATE, 1, 500),
      new Action(ActionType.ROTATE, 0.8, true, 500),
      new Action(ActionType.VIBRATE, 0.8, 500),
      new Action(ActionType.ROTATE, 0.5, true, 3_000),
      new Action(ActionType.VIBRATE, 0.5, 3_000),
      new Action(ActionType.ROTATE, 1, true, 2_000),
      new Action(ActionType.VIBRATE, 1, 2_000),
      new Action(ActionType.ROTATE, 0.2, true, 2_000),
      new Action(ActionType.VIBRATE, 0.2, 2_000),
      ...
      new Action(ActionType.ROTATE, 1, true, 2_000),
      new Action(ActionType.VIBRATE, 1, 2_000),
      new Action(ActionType.ROTATE, 1, false, 2_000),
      new Action(ActionType.VIBRATE, 1, 2_000),
      new Action(ActionType.ROTATE, 0.8, true, 2_000),
      new Action(ActionType.VIBRATE, 0.8, 2_000),
      new Action(ActionType.ROTATE, 0.7, true, 2_000),
      new Action(ActionType.VIBRATE, 0.7, 2_000),
      new Action(ActionType.ROTATE, 0.8, true, 2_000),
      new Action(ActionType.VIBRATE, 0.8, 2_000),
      new Action(ActionType.ROTATE, 1, true, 3_000),
      new Action(ActionType.VIBRATE, 1, 3_000),
      new Action(ActionType.ROTATE, 1, false, 2_000),
      new Action(ActionType.VIBRATE, 1, 2_000),
      new Action(ActionType.ROTATE, 0.8, true, 2_000),
      new Action(ActionType.VIBRATE, 0.8, 2_000),
                    ...
                    Manager.twitchWebSocket.on('message', async (data) => {
                      ...
                      if (message.type === 'MESSAGE' && message.data) {
                        ...
                        if (redemptionMessage.type === 'reward-redeemed') {
                          ...
                          const redeem = Manager.twitchRedeems.find((r) => r.getTitles().includes(redemption.reward.title));
                          redeem.getActions().forEach(action => {
                            switch(action.getActionType()) {
                              case ActionType.ROTATE:
                                Manager.activeDevices.forEach(async (device) => {
                                  await device.rotateFor(action.getSpeed(), action.isClockwise(), action.getDuration());
                                });
                                break;
                              case ActionType.VIBRATE:
                                Manager.activeDevices.forEach(async (device) => {
                                  await device.vibrateFor(action.getSpeed(), action.getDuration());
                                });
                                break;
                              case ActionType.WAIT:
                                setTimeout(() => {
                                  console.log(`[Manager.ts] Waited ${action.getDuration()} milliseconds`);
                                }, action.getDuration());
                                break;
                            }
                          });
